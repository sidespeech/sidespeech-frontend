...
export default function OnBoarding() {
  ...
  return (
    <OnBoardingStyled className="onboarding">
      <ul className="steps">
        <li 
          className={`step1 ${currentStep >= 1 ? "active" : ""} ${currentStep > 2 ? "complete" : ""}`}
        ></li>
        <li 
          className={`step2  ${currentStep >= 2 ? "active" : ""} ${currentStep > 3 ? "complete" : ""}`}
        ></li>
        <li 
          className={`step3  ${currentStep >= 3 ? "active" : ""} ${currentStep > 4 ? "complete" : ""}`}
        ></li>
        <li 
          className={`step4  ${currentStep >= 4 ? "active" : ""}`}
        ></li>
      </ul>

      <div className="content text-center">
        <div 
          className={`step-content step1 ${currentStep == 1 ? "active" : ""}`}
        >
        ...
        <div 
          className={`step-content step2 ${currentStep == 2 ? "active" : ""}`}
        >
        ...
        <div 
          className={`step-content step3 ${currentStep == 3 ? "active" : ""}`}
        >
            <h1>Your avatar</h1>
        ...
        <div 
          className={`step-content step4 ${currentStep == 4 ? "active" : ""}`}
        >
