...
const PaginationControls = ({ className, currentPage = 1, id, onChangePage, style, totalPages = 1 }: PaginationControlsProps) => {
  return (
    <PaginationControlsStyled className={className} id={id} style={style}>
        <button className="prev-next-btn" disabled={currentPage === 1} onClick={() => onChangePage(currentPage - 1)}>
