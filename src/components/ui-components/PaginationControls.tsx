        ...
        <PaginationControlsStyled className={className} id={id} style={style}>
            ...
            {Array.from(Array(totalPages).keys()).map((pageNumber) => {
                if (
                    ...
                    (pageNumber > currentPage && pageNumber < currentPage + 1)
                )
                    return (
                        <button
                    ...
                    (totalPages > 5 && currentPage !== totalPages - 2 && pageNumber === totalPages - 2) ||
                    (totalPages > 5 && currentPage !== 1 && pageNumber === 1)
                )
                    return <span key={'...-' + currentPage}>...</span>;
                else return null;
            })}
