...
const DesktopMenu = ({userData}: DesktopMenuProps) => {
  ...
  return (
    <DesktopMenuStyled>
        <div>
            <Link to="/">
                <svg className={`dashboard-icon ${dashboardUrls.includes(pathname) ? 'active' : ''}`} width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex align-center justify-center">
            <svg className="logo" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
