          ...
          <div>
            ...
            <button className="close-icon" onClick={() => showModal(false)}>
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.39961 13.6496L0.349609 12.5996L5.94961 6.99961L0.349609 1.39961L1.39961 0.349609L6.99961 5.94961L12.5996 0.349609L13.6496 1.39961L8.04961 6.99961L13.6496 12.5996L12.5996 13.6496L6.99961 8.04961L1.39961 13.6496Z" fill="#B4C1D2" fillOpacity="0.4"/>
              </svg>
            </button>
          </div>
          <div>{title}</div>
