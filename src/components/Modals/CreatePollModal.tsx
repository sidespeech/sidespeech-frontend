...
export default function CreatePollModal({ showModal }: { showModal: any }) {
  ...
  const handleSavePoll = async () => {
    try {
      ...
      const createThePoll = await pollService.createPoll(selectedChannel?.id, window.ethereum.selectedAddress, proposalTitle, endDate, question, false, Object.values(answers), Date.now().toString());
