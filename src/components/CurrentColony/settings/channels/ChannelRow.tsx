...
const ChannelRowStyled = styled.div`
  display: flex;
  width: 100%;
...
export default function ChannelRow({
  ...
  return (
      <ChannelRowStyled key={channel["id"]}>
