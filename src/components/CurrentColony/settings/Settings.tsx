                          ...
                          <>
                            <div>
                              <TabItems 
                                cursor="pointer" 
                                key={subtitle['label']} 
                                className={`nav-link flex ${subtitle['active'] ? 'active' : ''} sidebar-item text-secondary-dark`} 
                                onClick={(e) => {
                              ...
                              >
                                ...
                                <svg className="arrow-right" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
