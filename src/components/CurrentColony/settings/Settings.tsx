                    ...
                    ( <div key={index} className="mt-2">
                      ...
                      {submenu["items"].map((subtitle: any, index: number) => {
                        return (
                          <>
                            <div>
                              <TabItems cursor="pointer" key={subtitle['label']} className={`nav-link flex ${subtitle['active'] ? 'active' : ''} sidebar-item text-secondary-dark`} onClick={(e) => handleTabs(subtitle['label'])}>
                                <subtitle.Icon />
                                {subtitle['label']}
