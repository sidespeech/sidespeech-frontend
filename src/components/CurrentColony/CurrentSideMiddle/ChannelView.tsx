...
export default function ChannelView() {
	const { selectedRoom, selectedChannel, announcementId, setThread, thread, setCreatePollModal } = useMiddleSide();
		...
		<>
			{selectedChannel && (
				<>
					...
					{selectedChannel.type === ChannelType.Textual && <AnnouncementList thread={undefined} />}
				</>
			)}
		</>
	);
