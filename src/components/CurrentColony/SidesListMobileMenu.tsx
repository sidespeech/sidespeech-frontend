						...
						{userData.sides.map(side => (
							...
							>
								<div
									...
									style={{ backgroundColor: isColor(side.sideImage) ? side.sideImage : '' }}
								>
									{!isColor(side.sideImage) ? (
										<img alt="" src={side.sideImage} />
									) : (
										<div>{side.name[0]}</div>
									)}
								</div>
