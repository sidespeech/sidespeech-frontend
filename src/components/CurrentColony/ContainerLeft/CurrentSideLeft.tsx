...
const CoverImg = styled.div<CoverImgProps>`
  ...
  width: 100%;
  background: 
    linear-gradient(180deg, rgba(27, 29, 48, 0) 0%, #1B1D30 100%), 
...
export default function CurrentSideLeft() {
  ...
  return (
    <ContainerLeft backgroundColor="var(--bg-secondary-light)" minWidth={210} height={100} paddingTop={0}>
      <CoverImg backgroundImage={currentSide?.sideImage} className="w-100 flex align-end justify-between px-2 py-2">
      ...
      <SidebarStyled className="px-1">
            ...
            AccordionButton={() => (
                <span className="fw-400 size-11 flex align-center">
                  <svg className="mr-2" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.875 9.83366L7.16667 5.12533L11.875 0.416992L16.5833 5.12533L11.875 9.83366ZM0.5 8.16699V1.50033H7.16667V8.16699H0.5ZM8.83333 16.5003V9.83366H15.5V16.5003H8.83333ZM0.5 16.5003V9.83366H7.16667V16.5003H0.5ZM2.16667 6.50033H5.5V3.16699H2.16667V6.50033ZM11.8958 7.50033L14.25 5.14616L11.8958 2.79199L9.54167 5.14616L11.8958 7.50033ZM10.5 14.8337H13.8333V11.5003H10.5V14.8337ZM2.16667 14.8337H5.5V11.5003H2.16667V14.8337Z" fill="#B4C1D2"/>
                  </svg>
        ...
        <Accordion
          AccordionButton={() => (
            <span className="fw-400 size-11 flex align-center">
              <svg className="mr-2" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.33366 13.6668C1.87533 13.6668 1.4831 13.5038 1.15699 13.1777C0.830326 12.851 0.666992 12.4585 0.666992 12.0002V2.00016C0.666992 1.54183 0.830326 1.14961 1.15699 0.823496C1.4831 0.496829 1.87533 0.333496 2.33366 0.333496H15.667C16.1253 0.333496 16.5178 0.496829 16.8445 0.823496C17.1706 1.14961 17.3337 1.54183 17.3337 2.00016V12.0002C17.3337 12.4585 17.1706 12.851 16.8445 13.1777C16.5178 13.5038 16.1253 13.6668 15.667 13.6668H2.33366ZM9.00033 7.8335L2.33366 3.66683V12.0002H15.667V3.66683L9.00033 7.8335ZM9.00033 6.16683L15.667 2.00016H2.33366L9.00033 6.16683ZM2.33366 3.66683V2.00016V12.0002V3.66683Z" fill="#B4C1D2"/>
              </svg>
