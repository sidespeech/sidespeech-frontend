    ...
    <ContainerLeftStyled>
            ...
            <div className="w-100 flex align-center justify-between">
              <span className="fw-700 size-14 open-sans flex align-center text-secondary">
                ...
                {currentSide?.firstCollection?.safelistRequestStatus === 'verified' && (
                  <svg className="ml-2" width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="toolbar-mobile">
        {thread ? (
          <div className="side-info-header-mobile">
            <div>
              <button onClick={() => navigate(-1)} className="arrow-icon">
                <svg className="ml-3" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <button onClick={() => setIsSidesListOpen(prevState => !prevState)} className="side-info-header-mobile">
        ...
        <SidesListMobileMenu currentSide={currentSide} onClose={() => setIsSidesListOpen(false)} open={isSidesListOpen} />
