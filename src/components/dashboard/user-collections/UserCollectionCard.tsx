...
const UserCollectionCard = ({ collection, onClick }: UserCollectionItemProps) => {
    ...
    return (
        ...
        collection ? 
        <UserCollectionCardStyled coverImage={collection?.media?.[0]?.thumbnail || collection.media[0]?.raw || collection?.opensea?.imageUrl}>
            <div className="cover-image">
                <div className="title-wrapper title-wrapper-mobile">
                    ...
                    <h3 className="title">{collection?.opensea?.collectionName || collection?.name || "{No Name}"}</h3>
            ...
            <div className="content">
                ...
                <div className="content-bottom">
                    ...
                    <Button classes='discover-btn' onClick={() => onClick?.(collection)}>Discover</Button>
                </div>
            </div>
        </UserCollectionCardStyled> : null
    )
}
