...
const UserCollectionCard = ({ collection, onClick }: UserCollectionItemProps) => {
    ...
    return collection ? (
        <UserCollectionCardStyled
            coverImage={collection?.media?.[0]?.thumbnail || collection.media[0]?.raw || collection?.opensea?.imageUrl}
        >
            <div className="cover-image">
                <div className="title-wrapper title-wrapper-mobile">
                    <div className="avatar">
                        <img
                            src={collection?.opensea?.imageUrl || collection.media[0]?.raw || FALLBACK_BG_IMG}
