...
const FeatureSideCardStyled = styled.div<CardStyledProps>`
	...
	background-image: linear-gradient(180deg, rgba(24, 26, 43, 0) 0%, #181a2b 100%),
...
const FeaturedSides = ({ featuredSides, sidesLoading }: FeatureSidesProps) => {
	...
	return (
		<FeatureSidesStyled className="fade-in-delay-2" totalSides={featuredSides.length} firstSide={firstSideShowing}>
				...
				{sidesLoading ? (
					...
					<div className="list-wrapper">
						...
						<button
							...
							disabled={featuredSides.length < 3 || firstSideShowing === featuredSides.length - 1}
							onClick={() => setFirstSideShowing(prevSide => prevSide + 1)}
						>
