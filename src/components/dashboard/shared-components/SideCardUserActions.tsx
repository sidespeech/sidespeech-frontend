...
const SideCardUserActions = ({ alertsCount, messagesCount, side, userProfiles }: SideCardUserActionsProps) => {
        ...
        <>
            ...
            {isLeaveConfirmationModalOpen && (
                <Modal 
                    body={
                        <div>
                            {isSideAdmin && <div>You are the admin</div>}
                            Are you sure you want to leave Side {side.name}?
                        </div>}
                    footer={
