        ...
        <nav className="navigation-menu">
            <ul>
                <li 
                    ...
                    onClick={() => navigate(tabKeys.explore)}
                >
                ...
                <li 
                    ...
                    onClick={() => navigate(tabKeys.mySides)}
                >
                ...
                <li 
                    className={`menu-item ${currentTab === tabKeys.invitations ? 'active' : ''}`}
                    onClick={() => navigate(tabKeys.invitations)}
                >
